...
//           </p>
//           <h1 className="text-[45px] max-[480px]:text-[20px]  max-[480px]:text-center  font-popins text-[#003760] font-semibold mt-4">
//             {t("citys.title1")}
//           </h1>
//           <h1 className="text-[45px] max-[480px]:text-[20px]  max-[480px]:text-center font-playfair text-[#F15C36] font-semibold italic ">
//             {t("citys.title2")}
//           </h1>
//           <p className="text-[16px]  max-[480px]:text-[10px] text-[#7A8A9E] font-roboto  mt-6 text-center ">
//             {t("citys.desc")}
//           </p>
//           <div className="grid grid-cols-[repeat(3,450px)]  min-[1280px]:grid-cols-[repeat(3,350px)] min-[768px]:grid-cols-[repeat(3,210px)] max-[480px]:grid-cols-[repeat(3,100px)] gap-10  max-[480px]:gap-3 mt-8 ">
//             <div className="relative group rounded-lg overflow-hidden shadow-2xl ">
//               {/* Rasm */}
//               <img
//                 src={davlat1}
//                 alt="team"
//                 className="w-full h-[315px] min-[768px]:h-[210px] max-[480px]:h-[100px]  object-cover transition-transform duration-500 group-hover:scale-110"
//               />
